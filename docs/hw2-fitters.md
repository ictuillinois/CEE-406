...
## CBR seating interpretation

A positive origin correction activates a shaded 0-to-δ₀ interval on the measured penetration axis, representing the travel attributed to piston seating or surface irregularity by that correction. A selectable 0.10/0.20-in probe shows a dotted uncorrected reading location and a dashed corrected location on the measured curve, joined by a rightward arrow. The nearby explanation contrasts measured target = standard penetration + correction with reading the standard penetration directly on the corrected curve. It explains that reading early underestimates CBR where pressure rises, without automatically calculating the student's CBR results. Guides beyond the test range are identified and do not extrapolate pressure. Zero or invalid corrections remove the interpretation visual.
