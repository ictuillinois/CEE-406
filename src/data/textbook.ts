...
export interface TextbookEntry {
  ...
  title: string;
  desc: string;
  // NOTE: there is deliberately no `pdf` field. The chapter PDFs were removed
  // from public/ and purged from git history — Huang is a copyrighted commercial
  // textbook and this repository is public. Chapter pages cite the book and link
  // to the University Library instead. See src/data/release.ts before re-adding
  // anything that would host the text.
  relatedHws: { id: string; label: string }[];
}

export const textbook: TextbookEntry[] = [
  {
    id: 'ch01', kind: 'chapter', num: '1', title: 'Introduction',
  ...
  {
    id: 'ch03', kind: 'chapter', num: '3', title: 'KENLAYER Computer Program',
  ...
  {
    id: 'ch04', kind: 'chapter', num: '4', title: 'Stresses and Deflections in Rigid Pavements',
  ...
  {
    id: 'ch05', kind: 'chapter', num: '5', title: 'KENSLABS Computer Program',
  ...
  {
    id: 'ch07', kind: 'chapter', num: '7', title: 'Material Characterization',
  ...
  {
    id: 'ch08', kind: 'chapter', num: '8', title: 'Drainage Design',
